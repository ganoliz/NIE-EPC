...
WARNING: *Course pages are being updated for the winter semester B241. The current information may not apply for this semester.*

// == News

// * **[21. 11. 2023]** The lecture schedule has been updated.
...
WARNING: It is strongly recommended not to enroll in this course **in case of no prior C++ knowledge and experience**.
