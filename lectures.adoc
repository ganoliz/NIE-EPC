...
[WARNING]
====
* According to the latest findings, links to the university SharePoint have hard set expiration dates, and the applied politics does not allow to extend them. As a consequence, the **links to lecture slides in the table below are becoming invalid**.
