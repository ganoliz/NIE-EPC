...
IMPORTANT: For the reason of the inability to disable RVO in {cpp}17, *use for testing either {cpp}11 or {cpp14}*. With the *GCC and Clang* implementations, this can be accomplished by the `pass:[-std=c++14]` and `pass:[-std=c++17]` command line arguments.
