...
* If any operations end with throwing an exception, the vectors that participate this operations must end up in a valid state.
...
* These are, for example, handling exception of only some types, incorrect exception propagation, unnecessary code branching, etc.
====
