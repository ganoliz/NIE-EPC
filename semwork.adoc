...
* [8.11.2021] Link to the test program #3: https://godbolt.org/z/h77qnd1n7. Testování *copy and move constructor* by means of a value type *without move semantics*.
