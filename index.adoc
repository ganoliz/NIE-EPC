...
* [24.11.2022] A typo has been identified in the `test.cpp` source file for the 5th programming assignment. To correct this typo, please rewrite the tested condition at line 52 from `v_move[1] == 3` to `v_move[2] == 3` in the _practical5_ branch.

* [24.11.2022] Rules for taking the exam in the teaching period were published; see xref:classification#[] for details.
