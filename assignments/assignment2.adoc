...
* These algorithms may make the vector class code more simple and readable, especially regarding the exception handling.
...
NOTE: Such implicitly created array does not contain any objects.
